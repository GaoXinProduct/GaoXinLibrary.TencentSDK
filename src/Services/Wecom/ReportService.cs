...
public sealed class ReportService
{
    ...
    {
        var resp = await _http.PostAsync<GetReportListResponse>("/cgi-bin/oa/journal/get_record_list", request, ct).ConfigureAwait(false);
    ...
    {
        var resp = await _http.PostAsync<GetReportDetailResponse>("/cgi-bin/oa/journal/get_record_detail", request, ct).ConfigureAwait(false);
