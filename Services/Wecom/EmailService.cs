...
public sealed class EmailService
{
    ...
    {
        return await _http.PostAsync<UpdateEmailAccountResponse>("/cgi-bin/exmail/app/update_email_account", request, ct);
    }
    ...
    {
        return await _http.PostAsync<GetEmailAccountResponse>("/cgi-bin/exmail/app/get_email_account", request, ct);
    }
    ...
    {
        return await _http.PostAsync<CreateMailGroupResponse>("/cgi-bin/exmail/app/add_mail_group", request, ct);
    }
    ...
    {
        return await _http.PostAsync<UpdateMailGroupResponse>("/cgi-bin/exmail/app/update_mail_group", request, ct);
    }
    ...
    {
        return await _http.PostAsync<DeleteMailGroupResponse>("/cgi-bin/exmail/app/del_mail_group", request, ct);
    }
    ...
    {
        return await _http.PostAsync<GetMailGroupDetailResponse>("/cgi-bin/exmail/app/get_mail_group_detail", request, ct);
    }
    ...
    {
        return await _http.PostAsync<SearchMailGroupResponse>("/cgi-bin/exmail/app/search_mail_group", request, ct);
    }
    ...
    {
        return await _http.PostAsync<CreatePublicMailboxResponse>("/cgi-bin/exmail/app/add_public_mailbox", request, ct);
    }
    ...
    {
        return await _http.PostAsync<UpdatePublicMailboxResponse>("/cgi-bin/exmail/app/update_public_mailbox", request, ct);
    }
    ...
    {
        return await _http.PostAsync<DeletePublicMailboxResponse>("/cgi-bin/exmail/app/del_public_mailbox", request, ct);
    }
    ...
    {
        return await _http.PostAsync<GetPublicMailboxDetailResponse>("/cgi-bin/exmail/app/get_public_mailbox_detail", request, ct);
    }
    ...
    {
        return await _http.PostAsync<SearchPublicMailboxResponse>("/cgi-bin/exmail/app/search_public_mailbox", request, ct);
    }
    ...
    {
        return await _http.PostAsync<GetClientSecretResponse>("/cgi-bin/exmail/app/get_client_secret_list", request, ct);
    }
    ...
    {
        return await _http.PostAsync<DeleteClientSecretResponse>("/cgi-bin/exmail/app/del_client_secret", request, ct);
    }
    ...
    {
        return await _http.PostAsync<GetEmailUnreadCountResponse>("/cgi-bin/exmail/app/get_unread_count", request, ct);
    }
    ...
    {
        return await _http.PostAsync<SetFunctionAttrResponse>("/cgi-bin/exmail/app/set_function_attr", request, ct);
    }
    ...
    {
        return await _http.PostAsync<GetFunctionAttrResponse>("/cgi-bin/exmail/app/get_function_attr", request, ct);
    }
}