...
/// <summary>创建会议投票主题请求</summary>
/// <remarks>doc path: /98834</remarks>
public record CreateMeetingVoteRequest
{
    ...
    public string VoteTitle { get; init; } = string.Empty;

    /// <summary>投票内容</summary>
    [JsonPropertyName("vote_content")]
    public string VoteContent { get; init; } = string.Empty;

    /// <summary>投票选项列表</summary>
    [JsonPropertyName("vote_options")]
    public List<string> VoteOptions { get; init; } = new();
