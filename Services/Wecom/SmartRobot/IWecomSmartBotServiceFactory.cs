...
/// {
///     private readonly ISmartRobotService _robot1 = botFactory.CreateClient("bot1");
...
public interface IWecomSmartBotServiceFactory
{
    ...
    /// <returns>对应的 <see cref="ISmartRobotService"/> 实例</returns>
    /// <exception cref="InvalidOperationException">指定名称的智能机器人服务未注册时抛出</exception>
    ISmartRobotService CreateClient(string name);
