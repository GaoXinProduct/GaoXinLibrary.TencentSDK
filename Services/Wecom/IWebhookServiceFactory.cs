...
/// 可通过此工厂在 <b>MVC Controller 构造函数</b>或普通服务中按名称获取对应的 <see cref="WebhookService"/> 实例。
/// </para>
/// <para>
/// 适用场景：MVC Controller 构造函数不支持 <c>[FromKeyedServices]</c>，注入工厂后通过 <see cref="IWebhookServiceFactory.CreateClient"/> 解析指定实例。
/// </para>
/// <example>
/// <b>注册（Program.cs）：</b>
/// <code>
...
public interface IWebhookServiceFactory
{
    ...
    WebhookService CreateClient(string name);
}
